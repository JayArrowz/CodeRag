...
services.AddSingleton<ILanguageAnalyzer, TsCompilerAnalyzer>(); // .ts/.tsx via TS Compiler API sidecar
services.AddSingleton<ILanguageAnalyzer, TypeScriptAnalyzer>(); // .js/.jsx via tree-sitter
